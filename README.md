# Sensirion I2C SFM3505 embedded Library

This document explains how to set up a SFM3505 sensor
...
Your sensor has 5 pins that need to be connected to your board: SDA, VDD, GND, SCL, SRDY.
Use the following description to connect your SFM3505:
...
5. Run the compiled executable with `./sfm3505_i2c_example_usage`
...
5. Run the compiled executable with `./sfm3505_test_hw_i2c`.
